...
public class Customer implements Serializable {
    ...
    /**
     * This is a method called logOrder that takes an Order object as an
     * argument and sets the mostRecentOrder instance variable of the current
     * Customer object to the passed order.
     * 
     * The purpose of this method is to log the most recent order made by the
     * customer. The mostRecentOrder variable allows other parts of the program
     * to retrieve the customer's most recent order without having to search
     * through the customer's entire order history.
     * 
     * Note that this method does not return anything, it only sets the
     * mostRecentOrder variable.
     *
     * @param order
     */
